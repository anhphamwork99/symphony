...
projectionSnapshotLayer("ProjectionSnapshotQuery", (it) => {
  ...
  it.effect("prepares an empty global snapshot with zero pi subagent executions", () =>
    Effect.gen(function* () {
      // Regression (WP-04a): the global execution-card query used to fail at
      // prepare time (`no such column: base.observed_state`) because its
      // ranked subquery is aliased `ranked`, not `base`. An empty database
      // still prepares and executes the statement, so the empty snapshot is
      // a sufficient prepare regression.
      const snapshotQuery = yield* ProjectionSnapshotQuery;
      const sql = yield* SqlClient.SqlClient;
    ...
    () =>
      Effect.gen(function* () {
        ...
        INSERT INTO projection_projects (
          ...
          'project-global-cards', 'Global cards', '/tmp/global-cards',
          '{"provider":"pi","model":"deterministic"}', '[]',
      ...
      `;
        ...
        INSERT INTO projection_threads (
          ...
          'thread-global-cards', 'project-global-cards', 'Global cards parent',
          '{"provider":"pi","model":"deterministic"}', NULL, NULL, NULL,
      ...
      `;
        ...
        INSERT INTO pi_subagent_executions (
          ...
          parent_tool_call_id, agent_type, prompt, mode, cancellation_scope,
          desired_state, observed_state, diagnostic_code, rejection_reason,
          first_attempt_id, first_attempt_generation,
          last_heartbeat_at, lease_expires_at, last_progress_json, last_progress_at,
          dropped_progress_count, terminal_summary, terminal_transcript_ref,
          created_at, updated_at
        ) VALUES
          (
            'exec-global-live', 'exec-global-live_att1', 1,
            'cmd_spawn_exec-global-live', 'fp_exec-global-live',
            NULL, NULL, 'project-global-cards', 'thread-global-cards', NULL,
            NULL, 'worker', 'Do the delegated work', 'foreground', 'parent_turn',
            'running', 'running', NULL, NULL,
            NULL, NULL,
            NULL, NULL, NULL, NULL,
            0, NULL, NULL,
            '2026-08-23T00:00:02.000Z', '2026-08-23T00:00:02.000Z'
          ),
          (
            'exec-global-detached', 'exec-global-detached_att1', 1,
            'cmd_spawn_exec-global-detached', 'fp_exec-global-detached',
            NULL, NULL, 'project-global-cards', 'thread-global-cards', NULL,
            NULL, 'worker', 'Do the delegated work', 'foreground', 'parent_turn',
            'running', 'running', NULL, NULL,
            NULL, NULL,
      ...
      `;
        ...
        INSERT INTO pi_subagent_lifecycle_journal (
          ...
          (
            'journal-exec-global-detached-3', 'exec-global-detached',
            'exec-global-detached_att1', 1, 3, 'detached',
            '2026-08-23T00:00:03.500Z', NULL, NULL,
            '{"phase":"detached"}'
          ),
          (
            'journal-exec-global-live-75', 'exec-global-live',
            'exec-global-live_att1', 1, 75, 'teardown_requested',
            '2026-08-23T00:00:04.000Z', NULL, NULL, NULL
          ),
          (
            'journal-exec-global-detached-75', 'exec-global-detached',
            'exec-global-detached_att1', 1, 75, 'teardown_requested',
      ...
      `;
        ...
        INSERT INTO pi_subagent_completion_outbox (
          ...
          attempt_count, last_error, superseded_by_generation, delivered_at,
          acknowledged_at, created_at, updated_at
        ) VALUES (
          'outbox-global-live', 'exec-global-live', 'exec-global-live_att1', 1,
          'event-terminal-exec-global-live', 'thread-global-cards', 'pending',
          'succeeded', 'delegated work done', 'transcript://exec-global-live',
          0, NULL, NULL, NULL, NULL,
          '2026-08-23T00:00:05.000Z', '2026-08-23T00:00:05.000Z'
        )
      `;
