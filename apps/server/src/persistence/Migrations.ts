...
import Migration0097 from "./Migrations/097_ProjectMcpActivation.ts";
import Migration0098 from "./Migrations/098_PiSubagentExecutions.ts";
import Migration0099 from "./Migrations/099_PiSubagentLeasesAndProgress.ts";
...
import Migration0104 from "./Migrations/104_PiSubagentResumeDelegation.ts";
import Migration0105 from "./Migrations/105_ProjectWorkspaceStagedPublication.ts";
...
export const migrationEntries = [
  ...
  [97, "ProjectMcpActivation", Migration0097],
  [98, "PiSubagentExecutions", Migration0098],
  [99, "PiSubagentLeasesAndProgress", Migration0099],
  ...
  [104, "PiSubagentResumeDelegation", Migration0104],
  [105, "ProjectWorkspaceStagedPublication", Migration0105],
] as const;
...
export const MIGRATION_LINEAGE_ALIASES: readonly MigrationLineageAlias[] = [
  ...
  {
    // Shipped in v0.7.2-symphony.1 and v0.7.2-symphony.2 at ID 90. Relocated to ID 97
    // to reconcile with upstream v0.7.2 migrations 90-96.
    // Symphony databases have applied this schema, but still need upstream migrations 90-96 to run.
    // Setting historicalSlotRequiresRerun: true ensures the slot is cleared so upstream 90
    // (ProjectionThreadMessageTextSegments) and 91-96 run, while 97 (ProjectMcpActivation)
    // runs idempotently.
    historicalId: 90,
    historicalName: "ProjectMcpActivation",
    currentId: 97,
