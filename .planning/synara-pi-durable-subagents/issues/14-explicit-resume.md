...
- [x] **T14-AC2:** Late events, terminals, cancels, or completions from the prior
      attempt are ignored and counted after resume.
- [x] **T14-AC3:** Startup, reconciliation, heartbeat, transcript discovery, and
      model behavior contain no automatic resume trigger.
- [x] **T14-AC4:** Resume re-runs project/thread authorization, active-turn
      policy, quotas, and admission; denial creates no child.
- [x] **T14-AC5:** The orphaned execution shows the new attempt as queued or
      running while retaining prior-attempt evidence and updated diagnostics.
- [x] **T14-AC6:** Work capable of write or external side effects requires the
